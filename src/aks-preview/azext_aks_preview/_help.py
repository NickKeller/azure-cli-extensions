...
helps[
    ...
    examples:
        ...
        - name: Create a kubernetes cluster with the AKS Deployment Safeguards Level set to "Warning"
          text: az aks create -g MyResourceGroup -n MyManagedCluster --safeguards-level Warning --enable-addons azure-policy
        - name: Create a kubernetes cluster with the AKS Deployment Safeguards Level set to "Warning" and some namespaces excluded
...
helps[
    ...
    examples:
      ...
      - name: Update a kubernetes cluster with the AKS Deployment Safeguards Level set to "Warning". Assumes azure policy addon is already enabled
        text: az aks update -g MyResourceGroup -n MyManagedCluster --safeguards-level Warning
      - name: Update a kubernetes cluster with AKS Deployment Safeguards Level set to "Warning" and some namespaces excluded. Assumes azure policy addon is already enabled
        text: az aks update -g MyResourceGroup -n MyManagedCluster --safeguards-level Warning --safeguards-excluded-ns ns1,ns2
      - name: Update a kubernetes cluster to clear any namespaces excluded from AKS Deployment Safeguards. Assumes azure policy addon is already enabled
